package com.terry.demo.service.sign;
...
public class AdminSignService {
     ...
     * @return
     */
    public ResponseEntity<?> getAdminSignIn(SigninRequest signinRequest) {
     ...
     * @return
     */
    public ResponseEntity<?> getAdminAccesstoken(HttpServletRequest request, HttpServletResponse response) {
     ...
     * @return
     */
    public ResponseEntity<?> getAadminSignLogout(HttpServletRequest request, HttpServletResponse response) {
