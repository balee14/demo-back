package com.terry.demo.core.jwt;

import com.terry.demo.core.dto.CommonCustomType;
import com.terry.demo.core.util.KpCommonUtils;
...
public class JwtTokenProvider implements InitializingBean {
    ...
    public String createAccessToken(SigninDto signinDto) {
        ...
        String memberAuthorityStr = KpCommonUtils.listStringToString(signinDto.getMemberAuthority(), ",");
