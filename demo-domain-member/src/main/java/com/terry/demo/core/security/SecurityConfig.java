...
import com.terry.demo.core.config.enumeration.EnvType;
import com.terry.demo.core.jwt.JwtAuthenticationFilter;
import com.terry.demo.core.jwt.JwtExceptionFilter;
import com.terry.demo.core.jwt.JwtTokenProvider;
import com.terry.demo.core.util.KpPropertyUtil;
import com.terry.demo.member.service.CustomUserDetailsService;
...
//    public static final String IP_CHECK_PATH_PATTERN = IP_CHECK_PATH_PREFIX + "/**";
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        if(EnvType.isJwtType(KpPropertyUtil.getProperty("spring.profiles.active"))) {

            httpSecurity.authorizeHttpRequests((authorize) -> authorize
                .requestMatchers("/api/admin/v1/sign/in").permitAll() // 로그인
        ...
        httpSecurity
                ...
                .logout(logout -> logout
                        .logoutUrl("/api/admin/v1/sign/out")
