...
public class MemberService {
     ...
     * @return
     */
    public KpMember memberSave(KpMember kpMember) {
        ...
        // 권한 설정
        KpAuthority authority;
        // 어드민 사용자
        authority = KpAuthority.builder()
...
//        }
    ...
    public Long memberUpdate(MemberUpdateRequest memberUpdateRequest) {
        ...
        memberUpdateRequest.setModId(KpMemberUtil.getIdEmail());
    ...
    public Long memberPwdUpdate(MemberPwdUpdateRequest memberPwdUpdateRequest) {
        ...
        memberPwdUpdateRequest.setModId(KpMemberUtil.getIdEmail());
